...
if __name__ == "__main__":
    ...
    required_scripts = ["gps.py", "sensor.py", "sql/run_all_handlers.py"]
    ...
    run_in_background(f"python gps.py {trip_id}")
    run_in_background(f"python sensor.py {trip_id}")
    ...
    print("Running scoring.py to calculate scores for the trip...")
    try:
        os.system(f"python scoring.py {trip_id}")
        print("Scoring completed successfully.")
    except Exception as e:
        print(f"Error running scoring.py: {e}")
        exit(1)