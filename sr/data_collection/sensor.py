...
url = "http://54.241.86.221:8080/api/v1/rSnQtLBWzPAdM9tD0hyp/telemetry"
headers = {"Content-Type": "application/json"}

# Mapping of desired keys to actual sensor names
sensors = {
    "linear_acceleration": "Linear Acceleration Sensor",
    "accelerometer": "LSM6DSV Accelerometer",
    "magnetometer": "MMC56X3X Magnetometer",
    "gyroscope": "LSM6DSV Gyroscope"
}
